...
# read -p "Are you sure destroyed 60-catalogue,40-databasees IN BASTION? cpoy this :    for i in 90-components/ 40-databases/; do cd $i; terraform destroy -auto-approve; cd .. ;done
#  (yes/no): " confirm
# if [ "$confirm" != "yes" ]; then
#   echo "Destroy cancelled."
#   exit 1
...
# read -p "Are you sure destroyed 40-databases  check dependency 40 and 60  IN BASTION? (yes/no): " confirm
# if [ "$confirm" != "yes" ]; then
#   echo "Destroy cancelled."
#   exit 1
# fi
